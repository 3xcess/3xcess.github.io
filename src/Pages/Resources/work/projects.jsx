        ...
        <div className="container">
          <div className="row flex-column-reverse">
            <div className="col-md-12 d-flex justify-content-end align-items-bottom">
                ...
                <a className='px-2 text-right' href="https://raw.githubusercontent.com/3xcess/3xcess.github.io/main/src/assets/CV_PDF.pdf" target="_blank"><img width="20" height="20" src={cv} className="logo" alt="github" /></a>
            </div>
